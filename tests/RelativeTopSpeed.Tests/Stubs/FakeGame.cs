...
namespace SEStubs
{
    ...
    public sealed partial class FakePlayer : IMyPlayer
    {
    ...
    public sealed partial class FakeSession : IMySession
    {
    ...
    public sealed partial class FakeUtilities : IMyUtilities
    {
    ...
    /// </summary>
    public sealed partial class FakeMultiplayer : IMyMultiplayer
    {
        ...
        public void RegisterSecureMessageHandler(ushort id, Action<ushort, byte[], ulong, bool> messageHandler) { Secure[id] = messageHandler; }
        public void UnregisterSecureMessageHandler(ushort id, Action<ushort, byte[], ulong, bool> messageHandler) { if (Secure.TryGetValue(id, out var handler) && handler == messageHandler) Secure.Remove(id); }
    ...
    public sealed partial class FakeEntities : IMyEntities
    {
        ...
        public void Remove(long entityId) { var entity = Registered[entityId]; Registered.Remove(entityId); OnEntityRemove?.Invoke(entity); }
    }
    ...
    public sealed class FakeGame : IDisposable
    {
        ...
        private FakeGame()
        {
            ...
            MyAPIGateway.GridGroups = new FakeGridGroups();
            MyAPIGateway.TerminalControls = new FakeTerminalControls();
            Sandbox.Definitions.MyDefinitionManager.Static = new Sandbox.Definitions.MyDefinitionManager();
